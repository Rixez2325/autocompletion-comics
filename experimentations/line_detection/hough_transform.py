...
minLineLength = 100
maxLineGap = 10
horizontal_lines = cv2.HoughLinesP(edges, 1, np.pi/180, 100, minLineLength, maxLineGap)
...
vertical_lines = cv2.HoughLinesP(edges_rotated, 1, np.pi/180, 100, minLineLength, maxLineGap)
